...
const defaultServices = [
  {
    ...
    desc: "Tampilkan bisnis kamu secara profesional dengan website modern dan elegan.",
  },
  {
    id: "2",
    icon: "🛒",
    title: "Toko Online",
    desc: "Jual produk secara online dengan sistem cepat, aman, dan mudah dikelola.",
  },
  {
    id: "3",
    icon: "📱",
    title: "Landing Page",
    desc: "Halaman promosi modern yang dioptimalkan untuk meningkatkan konversi.",
  },
  {
    id: "4",
    icon: "⚙️",
    title: "Web App & Dashboard",
    desc: "Sistem dashboard dan manajemen bisnis yang powerful dan scalable.",
  },
  {
    id: "5",
    icon: "🔍",
    title: "SEO Optimization",
    desc: "Optimasi SEO agar website mudah ditemukan di Google dan mesin pencari.",
  },
  {
    id: "6",
    icon: "🚀",
    title: "Maintenance & Support",
    desc: "Support teknis dan maintenance profesional setelah website selesai dibuat.",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-7">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-8 transition-all duration-500 hover:border-cyan-400/30 hover:bg-white/[0.05]"
            >
              {/* Hover Glow */}
        ...
        >
          <div className="inline-flex flex-col items-center rounded-3xl border border-white/10 bg-white/[0.03] px-8 py-10 backdrop-blur-xl">
            ...
            <a
              href="#kontak"
              className="mt-6 inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 px-7 py-4 text-sm font-semibold text-white shadow-2xl shadow-cyan-500/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-cyan-500/40"
            >
              Konsultasi Gratis
            </a>
          </div>
