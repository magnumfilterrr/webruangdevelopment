              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-5 left-5 flex flex-wrap gap-2">
                  {project.tech.slice(0, 2).map((t) => (
                    <span
                      key={t}
                      className="rounded-full border border-white/10 bg-black/30 backdrop-blur-md px-3 py-1 text-xs text-white"
                    >
                      {t}
                    </span>
                  ))}
                ...
                {project.projectUrl && (
                  ...
                  >
                    <div className="flex items-center justify-center rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 px-5 py-4 text-sm font-semibold text-white shadow-2xl shadow-cyan-500/20">
                      Lihat Project
                    </div>
                  </motion.a>
                )}
              ...
              <div className="relative p-7">
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  {project.tech.map((tech) => (
                    <span
                      key={tech}
                      className="rounded-full border border-cyan-500/10 bg-cyan-500/10 px-3 py-1 text-xs font-medium text-cyan-300"
                    >
                      {tech}
                    </span>
                  ))}
