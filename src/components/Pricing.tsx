      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-5 text-gray-400 text-base leading-relaxed">
            Solusi website modern dengan harga transparan dan desain premium
            untuk bisnis Anda.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          {plans.map((plan, index) => (
            ...
            >
              ...
              {/* Badge */}
              {plan.highlighted && (
                <div className="absolute top-5 right-5 rounded-full bg-cyan-500/15 border border-cyan-400/20 px-3 py-1 text-[10px] font-semibold text-cyan-300 uppercase tracking-wider">
                  Popular
                </div>
              )}
              ...
              <div className="relative p-7 flex flex-col h-full">
                ...
                <div className="mt-8">
                  ...
                  {plan.priceMax && (
                    <p className="mt-2 text-sm text-gray-500">
                      sampai Rp {plan.priceMax}
                    </p>
                  )}
                </div>

                {/* Divider */}
                <div className="my-7 h-px w-full bg-gradient-to-r from-cyan-500/20 to-transparent" />
                ...
                <motion.button
                  ...
                  className={`mt-8 inline-flex items-center justify-center gap-2 rounded-2xl py-3.5 text-sm font-semibold transition-all duration-300 ${
                    plan.highlighted
